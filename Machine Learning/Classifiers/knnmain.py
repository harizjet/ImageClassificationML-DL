...
surf_knn = KNeighborsClassifier(n_neighbors=11)
lbp_knn = KNeighborsClassifier(n_neighbors=11)
hog_knn = KNeighborsClassifier(n_neighbors=11)
harriscorner_knn = KNeighborsClassifier(n_neighbors=11)
