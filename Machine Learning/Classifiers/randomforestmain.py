...
surf_knn = RandomForestClassifier(n_estimators=100)
lbp_knn = RandomForestClassifier(n_estimators=100)
hog_knn = RandomForestClassifier(n_estimators=100)
harriscorner_knn = RandomForestClassifier(n_estimators=100)
